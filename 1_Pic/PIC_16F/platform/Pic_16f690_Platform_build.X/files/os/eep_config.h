...
#define EEP_APP_IDX 2 // application is using only one eep scrachpad
#define EEP_APP_START_IDX 10

#define TPTAL_EEP_BYTES (EEP_APP_START_IDX + EEP_APP_IDX)
...
#define EEP_SYS_IDX 6  // total  eep system variables are used
#define EEP_SYS_START_IDX 4
#define SYSTEM_MAINTAINACE_IDX EEP_SYS_START_IDX
#define SYSTEM_SHUT_DOWN_IDX 7
#define EEP_SYS_LAST_IDX (EEP_SYS_IDX+EEP_SYS_START_IDX)
...
#define EEP_APP_LAST_IDX (EEP_APP_START_IDX+EEP_APP_IDX)
