...
{
   #if(TMR_Os_Tmr_Co_Op_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(TMR_Os_Tmr_Co_Op_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG8(TMR_Os_Tmr_Co_Op_PERIOD_LSB_PTR));
   #endif /* (TMR_Os_Tmr_Co_Op_UsingFixedFunction) */
}
...
void TMR_Os_Tmr_Co_Op_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(TMR_Os_Tmr_Co_Op_PERIOD_LSB_PTR, period);
...
{
   #if(TMR_Os_Tmr_Co_Op_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(TMR_Os_Tmr_Co_Op_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG8(TMR_Os_Tmr_Co_Op_CAPTURE_LSB_PTR));
   #endif /* (TMR_Os_Tmr_Co_Op_UsingFixedFunction) */
}
...
void TMR_Os_Tmr_Co_Op_WriteCounter(uint8 counter) 
{
    ...
    #else
        CY_SET_REG8(TMR_Os_Tmr_Co_Op_COUNTER_LSB_PTR, counter);
