...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_UART_v2_30"
`include "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_UART_v2_30\B_UART_v2_30.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_UART_v2_30"
`include "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_UART_v2_30\B_UART_v2_30.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_PWM_v3_30"
`include "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_PWM_v3_30\B_PWM_v3_30.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_PWM_v3_30"
`include "C:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_PWM_v3_30\B_PWM_v3_30.v"
`endif

// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=true, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=128, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=2000, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_1, CY_INSTANCE_SHORT_NAME=PWM_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=PWM_1, )
module PWM_v3_30_3 (
    pwm2,
    tc,
    clock,
...
// I2C_v3_50(Address_Decode=1, BusSpeed_kHz=120, ClockInputVisibility=false, CtlModeReplacementString=SyncCtl, EnableWakeup=false, ExternalBuffer=false, Externi2cIntrHandler=false, ExternTmoutIntrHandler=false, FF=true, Hex=false, I2C_Mode=2, I2cBusPort=0, Implementation=1, InternalUdbClockToleranceMinus=25, InternalUdbClockTolerancePlus=5, NotSlaveClockMinusTolerance=25, NotSlaveClockPlusTolerance=5, PrescalerEnabled=false, PrescalerPeriod=3, Psoc3ffSelected=false, Psoc5AffSelected=false, Psoc5lpffSelected=true, RemoveI2cff=false, RemoveI2cUdb=true, RemoveIntClock=true, RemoveTimeoutTimer=true, SclTimeoutEnabled=false, SdaTimeoutEnabled=false, Slave_Address=8, SlaveClockMinusTolerance=5, SlaveClockPlusTolerance=50, TimeoutEnabled=false, TimeoutImplementation=0, TimeOutms=25, TimeoutPeriodff=39999, TimeoutPeriodUdb=39999, UDB_MSTR=false, UDB_MULTI_MASTER_SLAVE=false, UDB_SLV=false, UdbInternalClock=true, UdbRequiredClock=1920, UdbSlaveFixedPlacementEnable=false, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=I2C_v3_50, CY_CONTROL_FILE=I2C_Slave_DefaultPlacement.ctl, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=I2C_1, CY_INSTANCE_SHORT_NAME=I2C_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=I2C_1, )
module I2C_v3_50_4 (
    sda_o,
    scl_o,
    sda_i,
...
module top ;
    ...
    Timer_v2_70_0 TMR_Os_Tmr_Co_Op (
        .reset(Net_12),
        .interrupt(Net_335),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_88),
        .clock(Net_10));
    defparam TMR_Os_Tmr_Co_Op.CaptureCount = 2;
    defparam TMR_Os_Tmr_Co_Op.CaptureCounterEnabled = 0;
    defparam TMR_Os_Tmr_Co_Op.DeviceFamily = "PSoC5";
    defparam TMR_Os_Tmr_Co_Op.InterruptOnCapture = 0;
    defparam TMR_Os_Tmr_Co_Op.InterruptOnTC = 1;
    defparam TMR_Os_Tmr_Co_Op.Resolution = 8;
    defparam TMR_Os_Tmr_Co_Op.SiliconRevision = "0";

    Timer_v2_70_1 TMR_Os_Tmr_Pre_Emp (
        .reset(Net_57),
        .interrupt(Net_336),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_63),
        .clock(Net_64));
    defparam TMR_Os_Tmr_Pre_Emp.CaptureCount = 2;
    defparam TMR_Os_Tmr_Pre_Emp.CaptureCounterEnabled = 0;
    defparam TMR_Os_Tmr_Pre_Emp.DeviceFamily = "PSoC5";
    defparam TMR_Os_Tmr_Pre_Emp.InterruptOnCapture = 0;
    defparam TMR_Os_Tmr_Pre_Emp.InterruptOnTC = 1;
    defparam TMR_Os_Tmr_Pre_Emp.Resolution = 16;
    defparam TMR_Os_Tmr_Pre_Emp.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("80212275-099a-4a0b-aed4-25c75867d27b"),
    ...
    UART_v2_30_2 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_743),
        .tx_interrupt(Net_744),
        .rx_interrupt(Net_332),
        .tx_data(Net_789),
        .tx_clk(Net_790),
        .rx_data(Net_791),
        .rx_clk(Net_792));
	...
	wire [0:0] tmpOE__System_Switch_net;
	wire [0:0] tmpIO_0__System_Switch_net;
	wire [0:0] tmpINTERRUPT_0__System_Switch_net;
	electrical [0:0] tmpSIOVREF__System_Switch_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		System_Switch
		 (.oe(tmpOE__System_Switch_net),
		  .y({1'b0}),
		  .fb({Net_801}),
		  .io({tmpIO_0__System_Switch_net[0:0]}),
		  .siovref(tmpSIOVREF__System_Switch_net),
		  .interrupt({tmpINTERRUPT_0__System_Switch_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__System_Switch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__System_LED_net;
	wire [0:0] tmpFB_0__System_LED_net;
	wire [0:0] tmpIO_0__System_LED_net;
	wire [0:0] tmpINTERRUPT_0__System_LED_net;
	electrical [0:0] tmpSIOVREF__System_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		System_LED
		 (.oe(tmpOE__System_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__System_LED_net[0:0]}),
		  .io({tmpIO_0__System_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__System_LED_net),
		  .interrupt({tmpINTERRUPT_0__System_LED_net[0:0]}),
		  .annotation({Net_805}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__System_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("118a2312-3f1c-40db-bcd8-d4c232e97817"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bdb1de5d-d7e7-4821-89d2-a8367653a0b1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("90221c41-f321-4ef9-bd1a-f18b1a8f0806"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
