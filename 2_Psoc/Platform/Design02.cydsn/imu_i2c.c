...
void Read_From_ALL(void)
{
			switch(st_Read)
			{
				...
				case BYPASS_GYRO:   //  
					  ...
					  if( if(I2C_WRITE(GYRO_ADDRESS, Gyro_Calib_data[7],2)))   //  GYRO_ADDRESS,0x37,0x02
					  {
							st_Gyro=START_MAG;  // swith to next case after 10 ms
					  }
					 break;
				case START_MAG:
					  if( if(I2C_WRITE(MAG_ADDRESS, Mag_Calib_data[0],2)))   //  GYRO_ADDRESS,0x37,0x02
					  {
							st_Gyro=READ_MAG; 
					  }
