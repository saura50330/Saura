...
#define UART_Tx_ISR_INTC_VECTOR            ((reg32 *) UART_Tx_ISR__INTC_VECT)
...
#define UART_Tx_ISR_INTC_SET_EN            ((reg32 *) UART_Tx_ISR__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the UART_Tx_ISR interrupt. */
#define UART_Tx_ISR_INTC_CLR_EN            ((reg32 *) UART_Tx_ISR__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the UART_Tx_ISR interrupt state to pending. */
#define UART_Tx_ISR_INTC_SET_PD            ((reg32 *) UART_Tx_ISR__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the UART_Tx_ISR interrupt. */
#define UART_Tx_ISR_INTC_CLR_PD            ((reg32 *) UART_Tx_ISR__INTC_CLR_PD_REG)
